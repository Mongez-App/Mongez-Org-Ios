...
public protocol TeamCoursesRepository {
    ...
    // Member Management
    func getTeamMembers(teamId: String) async throws -> (pending: [TeamMember], active: [TeamMember])
    func acceptMember(memberId: String) async throws
    func declineMember(memberId: String) async throws
}
